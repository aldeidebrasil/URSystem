...
<%@page import="controller.vo.Admin"%>
...
</script><body onload="moveHour()">
       <div class="logout">
               <a href="/URSystem/servletweb?action=OpenAdmin"><img src="images/home.png" width="50" height="50" title="Home"></a>
            ...
            <div class="profile">
               ...
               <div id="newPassword" style="display: none;"> 
                   <form name="frmUpdatePasswordAdmin" method='post'>
                       ...
                       <b> New password:</b> <input type="password" name="password" id="password" size="16" style="line-height: 20px; font-size: 15px;"><br><br>
                        <button type="button" onClick="validateUpdatePasswordAdmin('<%=admin.getID()%>');">Change Password</button>
                </form> 
                </div>
            </div>
    </body>
