        ...
        <div class="actions">
           ...
           <form name="frmUpdateStudent" method='post'>
            <table style="border: 2px black solid">
                ...
                <tr class="even">
                    <td><%=student.getID()%></td>
                    <td> <input type="text" name="id" id="id" size="30" maxlength="10" value="<%=student.getID()%>" onchange="if(this.value != '') var boolean = callAjax(this.value, <%=students%>); if(boolean==false) this.value = null"  style="line-height: 40px; font-size: 20px;"></td>
                </tr>
                <tr>
