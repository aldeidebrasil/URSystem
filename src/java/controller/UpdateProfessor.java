        ...
        try {
            ...
            if(id!=idOld){
                ...
                if(listProfessorxcourse!=null){
                    if(!listProfessorxcourse.isEmpty()){
                        for(int i=0; i<listProfessorxcourse.size();i++){
                            ...
                            professorxcourseNew.setIdTerm(listProfessorxcourse.get(i).getIdTerm());
                            professorxcourseNew.setYear(listProfessorxcourse.get(i).getYear());
                    ...
                    Boolean update = ProfessorDAO.updateID(professorOld,idOld);
