      ...
      <div class="header">
        ...
        <div class="actions">
           <form name="frmDate" method='post'>
               ...
               Date Start Term: <input type="date" name="termDate" id="termDate"><br>
               Date Limit to Register: <input type="date" name="dateLimit" id="dateLimit"><br>
               Date Finish Term: <input type="date" name="dateEnd" id="dateEnd"><br>
